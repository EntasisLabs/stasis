...
- Verified Against: Stasis 0.9.4 release
...
This book documents the Stasis 0.9.x runtime architecture and operational semantics. Reference pages marked **Stable** are verified against the current release train. It does not define production deployment topology beyond the cookbook recipes.
