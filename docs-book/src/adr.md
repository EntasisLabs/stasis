...
- Plan: [Federated Job Contract](../../docs/design/federated-job-contract.md)
- Full ADR: [ADR-0010](../../docs/adr/ADR-0010-federated-job-contract.md)
...
- Plan: [WASM target phase plan](../../docs/design/wasm-target-phase-plan.md)
- Full ADR: [ADR-0009](../../docs/adr/ADR-0009-wasm-target-profile.md)
