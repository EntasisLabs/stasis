...
- Plan: [design/inbound-job-triggers.md](../design/inbound-job-triggers.md)
- Full ADR: [ADR-0012-inbound-job-triggers.md](ADR-0012-inbound-job-triggers.md)
...
- Plan: [design/typed-job-framework.md](../design/typed-job-framework.md)
- Full ADR: [ADR-0011-typed-job-framework.md](ADR-0011-typed-job-framework.md)
...
- Status: Accepted
- Context: Locus 0.5 and Grapheme 0.7 can target WASM, but `stasis-rs` was a native-only crate graph (Axum, SurrealKV, genai, `rt-multi-thread`) with no `wasm32` cfg or CI gate.
