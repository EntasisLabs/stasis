...
| WASM npm package | `npm --prefix stasis-wasm run build && npm --prefix stasis-wasm test && npm --prefix stasis-wasm run pack:dry` | Node/bundler package with TypeScript types (`private` until publish) |
