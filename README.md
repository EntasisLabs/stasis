...
| WASM npm package | `npm --prefix stasis-wasm run build && npm --prefix stasis-wasm test && npm --prefix stasis-wasm run pack:dry` | Node/bundler package with TypeScript types (`stasis-wasm@0.11.0`; publish with `./scripts/publish-npm.sh`) |
