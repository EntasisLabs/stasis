...
const IDENTITY_SCHEMA_STATEMENTS: &[&str] = &[
    "DEFINE TABLE identity_persona SCHEMALESS",
    "DEFINE TABLE identity_user SCHEMALESS",
    "DEFINE TABLE identity_channel_profile SCHEMALESS",
    "DEFINE TABLE identity_policy_profile SCHEMALESS",
    "DEFINE TABLE identity_relationship SCHEMALESS",
    "DEFINE TABLE identity_relationship_version SCHEMALESS",
    "DEFINE TABLE identity_entity_update_proposal SCHEMALESS",
    "DEFINE TABLE identity_relationship_transition SCHEMALESS",
