...
struct OutboxRecord {
    ...
    output_memory_node_id: Option<String>,
...
impl From<OutboxEvent> for OutboxRecord {
    fn from(value: OutboxEvent) -> Self {
        Self {
            ...
            output_memory_node_id: value.event.output_memory_node_id,
            retrieval_path: value.event.retrieval_path,
    ...
    fn try_from(value: OutboxRecord) -> std::result::Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            event: RuntimeEvent {
                ...
                output_memory_node_id: value.output_memory_node_id,
